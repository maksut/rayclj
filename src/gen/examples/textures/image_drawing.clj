...
(let [screen-width 800 screen-height 450]
  ...
  (let [cat (-> (rl/load-image "src/gen/examples/textures/resources/cat.png") ;; Load image in CPU memory (RAM)
        ...
        parrots (rl/load-image "src/gen/examples/textures/resources/parrots.png") ;; Load image in CPU memory (RAM)
        ...
        font (rl/load-font "src/gen/examples/textures/resources/custom_jupiter_crash.png")
