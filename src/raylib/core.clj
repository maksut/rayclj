(ns raylib.core
  ...
  (:import [raylib raylib_h Vector2]
...
(defn draw-fps! [pos-x pos-y] (raylib_h/DrawFPS pos-x pos-y))

; RLAPI void DrawText(const char *text, int posX, int posY, int fontSize, Color color);       // Draw text (using default font)

(defn draw-text!
  "Draw text (using default font)"
  [text x y font-size color] (raylib_h/DrawText (string text) x y font-size (structs/color color)))
