...
public class FilePathList {
    ...
    public static VarHandle paths$VH() {
     ...
     * }
     */
    public static MemorySegment paths$get(MemorySegment seg) {
     ...
     * }
     */
    public static void paths$set(MemorySegment seg, MemorySegment x) {
        constants$25.const$3.set(seg, x);
    }
    public static MemorySegment paths$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$25.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void paths$set(MemorySegment seg, long index, MemorySegment x) {
